...
#ifndef DRYDIFF                                
                                    IF((Vels1(XYZNodes(I)).LT.-90000D0).AND.(Vels2(XYZNodes(I)).GT.-90000D0))THEN
                                        Z(I) = BathLocal(XYZNodes(I)) - Vels2(XYZNodes(I))
                                    ELSEIF((Vels1(XYZNodes(I)).GT.-90000D0).AND.(Vels2(XYZNodes(I)).LT.-90000D0))THEN
                                        Z(I) = BathLocal(XYZNodes(I)) - Vels1(XYZNodes(I)) 
                                    ELSEIF((Vels1(XYZNodes(I)).LT.-90000D0).AND.(Vels2(XYZNodes(I)).LT.-90000D0))THEN
                                        Z(I) = 0.0d0
                                    ELSE
                                        Z(I) = Vels1(XYZNodes(I)) - Vels2(XYZNodes(I))
                                    ENDIF
